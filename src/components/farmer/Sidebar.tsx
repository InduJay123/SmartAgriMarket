// Sidebar.tsx
import { Bell, FileSpreadsheet, Home, LogOut, MessageSquare, MessagesSquare, PlusCircle, Settings, TrendingUp, User, Waves } from "lucide-react";
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
    ...
    const menuItems = [
        ...
        { name: "AI Insights", icon: TrendingUp, path: "/farmer/ai-insights" },
        { name: "Flood Detection", icon: Waves, path: "/farmer/flood-detection" },
